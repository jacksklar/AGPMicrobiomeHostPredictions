...
'country', 'diabetes_type', 'diet_type', 'elevation', 'fed_as_infant', 'level_of_education', 'race', 'sex',
'sleep_duration', 'state', 'weight_change', 'country_of_birth', 'country_residence', 'subset_healthy', 'survey_id']
