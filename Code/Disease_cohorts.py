...
# -*- coding: utf-8 -*-
"""
Created on Thu May 14 21:36:09 2020
...
def buildDataSubset(metadata_df, target_name):
    ...
    cohort.to_csv("/Users/jacksklar/Desktop/AGPMicrobiomeHostPredictions/Feature_Cohorts/Phase_II_Cohorts_disease_removed/binary_cohorts/" + str(target_name) + ".csv")
...
for disease in disease_list:
    ...
    disease_df = disease_df[disease_df["gluten"] != "I was diagnosed with celiac disease"]
    ...
    if n_feature_positive < 40:    ## Skip variables with less than 50 positive samples
        ...
        buildDataSubset(disease_df, disease)
