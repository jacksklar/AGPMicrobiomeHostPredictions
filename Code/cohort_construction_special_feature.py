...
create_custom_cohorts(save_path, exclude_diseases=False)

save_path = "/Users/jacksklar/Desktop/AGPMicrobiomeHostPredictions/Feature_Cohorts/Phase_II_Cohorts_disease_removed/binary_cohorts/"
create_custom_cohorts(save_path, exclude_diseases=True)