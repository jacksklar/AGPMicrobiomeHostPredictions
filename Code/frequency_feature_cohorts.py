...
for var in freq_values:
    ...
    for group in case_groups:
        ...
        cohort.to_csv("/Users/jacksklar/Desktop/AGPMicrobiomeHostPredictions/Feature_Cohorts/Phase_II_Cohorts_disease_removed/frequency_cohorts/" 
                      + var + file_names[group -1])
    print()
