...
obese_cohort = buildDataSubset(metadata_df_healthy, "bmi_cat", "Obese", "Normal")
...
obese_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/Obese_cohort.csv")
print len(obese_cohort)

print ("Constructing Overweight cohort with matched normal samples")
overweight_cohort = buildDataSubset(metadata_df_healthy, "bmi_cat", "Overweight", "Normal")
...
overweight_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/Overweight_cohort.csv")
print len(overweight_cohort)

print ("Constructing Underweight cohort with matched normal samples")
underweight_cohort = buildDataSubset(metadata_df_healthy, "bmi_cat", "Underweight", "Normal")
...
underweight_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/Underweight_cohort.csv")
...
ibd_cohort = buildDataSubset(metadata_df_healthy, "ibd", 1, 0)
ibd_cohort = metadata_matching.loc[ibd_cohort, :]
ibd_cohort["target"] = metadata_df_healthy.loc[ibd_cohort.index, "ibd"]
ibd_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/IBD_cohort.csv")
...
antiB_cohort1 = buildDataSubset(metadata_df_healthy, "antibiotic_history", "Year", "I have not taken antibiotics in the past year.")
...
antiB_cohort1.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/antiB_Year_cohort.csv")
print len(antiB_cohort1)

print ("Constructing Antiobiotic 6 Months cohort with matched healthy samples")
antiB_cohort2 = buildDataSubset(metadata_df_healthy, "antibiotic_history", "6 months", "I have not taken antibiotics in the past year.")
...
antiB_cohort2.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/antiB_6Month_cohort.csv")
print len(antiB_cohort2)

print ("Constructing Antiobiotic Year cohort with matched healthy samples")
antiB_cohort3 = buildDataSubset(metadata_df_healthy, "antibiotic_history", "Month", "I have not taken antibiotics in the past year.")
...
antiB_cohort3.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/antiB_Month_cohort.csv")
print len(antiB_cohort3)

print ("Constructing Antiobiotic Week cohort with matched healthy samples")
antiB_cohort4 = buildDataSubset(metadata_df_healthy, "antibiotic_history", "Week", "I have not taken antibiotics in the past year.")
...
antiB_cohort4.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/antiB_Week_cohort.csv")
...
diabetes_cohort = buildDataSubset(metadata_df_healthy, "diabetes_type", "Type II diabetes", ["Not provided", "Unspecified"])
...
diabetes_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/diabetes_typeII_cohort.csv")
...
print ("Constructing 18 and under cohort with matched healthy adults")
...
young = metadata_df_healthy_young[(metadata_df_healthy_young["age_years"] <= 18.0) & (metadata_df_healthy_young["age_years"] >= 5.0)].index
...
young_cohort = buildDataSubset(metadata_df_healthy_young, "age_group", 1, 0)
...
young_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/age_under18.csv")
...
infant = metadata_df_healthy_infant[metadata_df_healthy_infant["age_years"] <= 4.0].index
...
infant_cohort = buildDataSubset(metadata_df_healthy_infant, "age_group", 1, 0)
...
infant_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/age_under5.csv")
...
old_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/age_over70.csv")
print len(old_cohort)

metadata_df_healthy = metadata_df_healthy.loc[:, ["age_years", "age_cat", "sex", "bmi", "longitude", "latitude", "race"]]
metadata_df_healthy.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/age_healthy_cohort.csv")
...
gender_healthy_cohort = buildDataSubset(metadata_df_healthy, "sex", "male", "female")
...
gender_healthy_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/gender_healthy_cohort.csv")
...
alc_cohort = buildDataSubset(metadata_df_healthy, "alcohol_frequency", 1, 0)
alc_cohort = metadata_matching.loc[alc_cohort, :]
alc_cohort["target"] = metadata_df_healthy.loc[alc_cohort.index, "alcohol_frequency"]

alc_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/alcohol_rare_cohort.csv")


print ("Constructing alcohol occasional cohort with matched healthy samples")
alc_cohort = buildDataSubset(metadata_df_healthy, "alcohol_frequency", 2, 0)
alc_cohort = metadata_matching.loc[alc_cohort, :]
alc_cohort["target"] = metadata_df_healthy.loc[alc_cohort.index, "alcohol_frequency"]
alc_cohort.loc[alc_cohort["target"] == 2, "target"] = 1
alc_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/alcohol_occasional_cohort.csv")


print ("Constructing alcohol regular cohort with matched healthy samples")
alc_cohort = buildDataSubset(metadata_df_healthy, "alcohol_frequency", 3, 0)
alc_cohort = metadata_matching.loc[alc_cohort, :]
alc_cohort["target"] = metadata_df_healthy.loc[alc_cohort.index, "alcohol_frequency"]
alc_cohort.loc[alc_cohort["target"] == 3, "target"] = 1
alc_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/alcohol_regular_cohort.csv")


print ("Constructing alcohol daily with matched healthy samples")
alc_cohort = buildDataSubset(metadata_df_healthy, "alcohol_frequency", 4, 0)
alc_cohort = metadata_matching.loc[alc_cohort, :]
alc_cohort["target"] = metadata_df_healthy.loc[alc_cohort.index, "alcohol_frequency"]
alc_cohort.loc[alc_cohort["target"] == 4, "target"] = 1
alc_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/alcohol_daily_cohort.csv")
...
pill_cohort = buildDataSubset(metadata_df_healthy, "contraceptive", "Yes, I am taking the \"pill\"", "No")
...
pill_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/pill_cohort.csv")


print ("Constructing IUD cohort with matched healthy samples")
iud_cohort = buildDataSubset(metadata_df_healthy, "contraceptive", "Yes, I use a hormonal IUD (Mirena)", "No")
...
iud_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/iud_cohort.csv")
...
asd_cohort = buildDataSubset(metadata_df_healthy, "asd", 1, 0)
asd_cohort = metadata_matching.loc[asd_cohort, :]
asd_cohort["target"] = metadata_df_healthy.loc[asd_cohort.index, "asd"]
asd_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/asd_cohort.csv")
...
no_gluten_cohort = buildDataSubset(metadata_df_healthy, "gluten", "I do not eat gluten because it makes me feel bad", "No")
...
no_gluten_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/no_gluten_cohort.csv")

print ("Constructing celiac cohort with matched healthy samples")
celiac_cohort = buildDataSubset(metadata_df_healthy, "gluten", "I was diagnosed with celiac disease", "No")
...
celiac_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/celiac_cohort.csv")

print ("Constructing gluten_allergy cohort with matched healthy samples")
gluten_alergy_cohort = buildDataSubset(metadata_df_healthy, "gluten", "I was diagnosed with gluten allergy (anti-gluten IgG), but not celiac disease", "No")
...
gluten_alergy_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/gluten_alergy_cohort.csv")
...
usa_immigrant_cohort = buildDataSubset(metadata_df_healthy, "immigrant", 1, 0)
...
usa_immigrant_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/usa_immigrant_cohort.csv")
...
uk_immigrant_cohort = buildDataSubset(metadata_df_healthy, "immigrant", 1, 0)
...
uk_immigrant_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/uk_immigrant_cohort.csv")

###DIET TYPE GROUPS
print ("Constructing diet:  cohort with matched healthy samples")
omnivore_noRed_cohort = buildDataSubset(metadata_df_healthy, "diet_type", "Omnivore but do not eat red meat", "Omnivore")
...
omnivore_noRed_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/omnivore_noRed_cohort.csv")



print ("Constructing diet: Pescatarian cohort with matched healthy samples")
pescatarian_cohort = buildDataSubset(metadata_df_healthy, "diet_type", "Vegetarian but eat seafood", "Omnivore")
...
pescatarian_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/pescatarian_cohort.csv")


print ("Constructing diet: Vegetarian cohort with matched healthy samples")
vegetarian_cohort = buildDataSubset(metadata_df_healthy, "diet_type", "Vegetarian", "Omnivore")
...
vegetarian_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/vegetarian_cohort.csv")


print ("Constructing diet: Vegan cohort with matched healthy samples")
vegan_cohort = buildDataSubset(metadata_df_healthy, "diet_type", "Vegan", "Omnivore")
...
vegan_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/vegan_cohort.csv")


print ("Constructing BMF 1 cohort with matched healthy samples")
bmf_less1_cohort = buildDataSubset(metadata_df_healthy, "bowel_movement_frequency", "Less than one", "One")
...
bmf_less1_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/bmf_less1_cohort.csv")


print ("Constructing BMF 2 cohort with matched healthy samples")
bmf_2_cohort = buildDataSubset(metadata_df_healthy, "bowel_movement_frequency", "Two", "One")
...
bmf_2_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/bmf_2_cohort.csv")


print ("Constructing BMF 3 cohort with matched healthy samples")
bmf_3_cohort = buildDataSubset(metadata_df_healthy, "bowel_movement_frequency", "Three", "One")
...
bmf_3_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/bmf_3_cohort.csv")

print ("Constructing BMF 4 cohort with matched healthy samples")
bmf_4_cohort = buildDataSubset(metadata_df_healthy, "bowel_movement_frequency", "Four", "One")
...
bmf_4_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/bmf_4_cohort.csv")

print ("Constructing BMF 5 cohort with matched healthy samples")
bmf_5_cohort = buildDataSubset(metadata_df_healthy, "bowel_movement_frequency", "Five or more", "One")
...
bmf_5_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/bmf_5_cohort.csv")
...
bmq_solid_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/bmq_solid_cohort.csv")
...
bmq_loose_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/bmq_loose_cohort.csv")


print ("Constructing weight increase cohort with matched healthy samples")
weigth_increase_cohort = buildDataSubset(metadata_df_healthy, "weight_change", "Increased more than 10 pounds", "Remained stable")
...
weigth_increase_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/weigth_increase_cohort.csv")

print ("Constructing weight decrease cohort with matched healthy samples")
weigth_decrease_cohort = buildDataSubset(metadata_df_healthy, "weight_change", "Decreased more than 10 pounds", "Remained stable")
...
weigth_decrease_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/weigth_decrease_cohort.csv")
...
cauc_cohort = buildDataSubset(metadata_df_healthy, "race", "Caucasian", ["Asian or Pacific Islander", "Hispanic", "African American"])
...
cauc_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/caucasian_cohort.csv")

print ("Constructing asian cohort with matched healthy samples")
asian_cohort = buildDataSubset(metadata_df_healthy, "race", "Asian or Pacific Islander", ["Caucasian", "Hispanic", "African American"])
...
asian_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/asian_cohort.csv")

print ("Constructing AA cohort with matched healthy samples")
africanA_cohort = buildDataSubset(metadata_df_healthy, "race", "African American", ["Caucasian", "Asian or Pacific Islander", "Hispanic"])
...
africanA_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/african_american_cohort.csv")

print ("Constructing hispanic cohort with matched healthy samples")
hispanic_cohort = buildDataSubset(metadata_df_healthy, "race", "Hispanic", ["Caucasian", "Asian or Pacific Islander", "African American"])
...
hispanic_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/Feature_cohorts/hispanic_cohort.csv")
