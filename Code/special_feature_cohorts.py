...
young_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/binary_cohorts/age_under18.csv")
...
infant_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/binary_cohorts/age_under5.csv")
...
old_cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Results/binary_cohorts/age_over70.csv")
...
for n,i in enumerate(range(4, 36)):
    age_window = range(i-3, i+1)    
    age_window = [float(age) for age in age_window]
    control_min = max([i+1, 18])
    print n, age_window, control_min
    
    #young = metadata_df_healthy[(metadata_df_healthy["age_years"] <= float(i)) & (metadata_df_healthy["age_years"] >= float(i-3))].index
