...
def buildDataSubset(target_name, base_match):
    ...
    cohort.to_csv("/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Feature_Cohorts/binary_cohorts_updated/" + str(target_name) + ".csv")
...
###informed Matching cohorts: base + alcohol and Diet
for feature in binary_features:
    feature_counts = metadata_df[feature].value_counts()
    if 1 not in feature_counts.index:
        continue
