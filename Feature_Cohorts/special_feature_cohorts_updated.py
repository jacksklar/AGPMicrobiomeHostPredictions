...
# -*- coding: utf-8 -*-
"""
Created on Tue May 28 12:06:12 2019
...
metadata_df["diet_type"] = metadata_df["diet_type"].map({"Omnivore": 0,"Omnivore but do not eat red meat": 1,"Vegetarian but eat seafood": 2,
...
updated_cohort_path = "/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Feature_Cohorts/binary_cohorts_updated/"
updated_age_path = "/Users/sklarjg/Desktop/MICROBIOME/AmericanGutProj/Feature_Cohorts/age_cohorts_updated/"
...
obese_cohort.to_csv(updated_cohort_path + "Obese_cohort.csv")
...
overweight_cohort.to_csv(updated_cohort_path + "Overweight_cohort.csv")
...
underweight_cohort.to_csv(updated_cohort_path + "Underweight_cohort.csv")
...
ibd_cohort.to_csv(updated_cohort_path + "IBD_cohort.csv")
...
antiB_cohort1.to_csv(updated_cohort_path + "antiB_Year_cohort.csv")
...
antiB_cohort2.to_csv(updated_cohort_path + "antiB_6Month_cohort.csv")
...
antiB_cohort3.to_csv(updated_cohort_path + "antiB_Month_cohort.csv")
...
antiB_cohort4.to_csv(updated_cohort_path + "antiB_Week_cohort.csv")
...
diabetes_cohort.to_csv(updated_cohort_path + "diabetes_typeII_cohort.csv")
...
young_cohort.to_csv(updated_cohort_path + "age_6-18.csv")
...
infant_cohort.to_csv(updated_cohort_path + "age_3-5.csv")
...
infant_cohort = metadata_matching.loc[infant_cohort, :]
infant_cohort["target"] = metadata_df_healthy_infant.loc[infant_cohort.index, "age_group"]
infant_cohort.to_csv(updated_cohort_path + "age_1-2.csv")
print len(infant_cohort)
...
old_cohort.to_csv(updated_cohort_path + "age_over65.csv")
print len(old_cohort)

metadata_df_healthy = metadata_df_healthy.loc[:, ["age_years", "age_cat", "sex", "bmi", "longitude", "latitude", "race"]]
metadata_df_healthy.to_csv(updated_cohort_path + "age_healthy_cohort.csv")
...
for n,i in enumerate(range(4, 41)):
    ...
    young_cohort.to_csv(updated_age_path + "age_under" + str(i+1) + ".csv")
...
metadata_df_healthy = metadata_df_healthy[metadata_df_healthy["ibd"] == 0]
metadata_df_healthy = metadata_df_healthy[metadata_df_healthy["sex"] != 2]
metadata_df_healthy = metadata_df_healthy[metadata_df_healthy["diabetes"] == 0]
metadata_df_healthy = metadata_df_healthy[metadata_df_healthy["antibiotic_history"].isin(["Year", "I have not taken antibiotics in the past year."])]

gender_healthy_cohort = buildDataSubset(metadata_df_healthy, "sex", 1, 0, False)
...
gender_healthy_cohort.to_csv(updated_cohort_path + "gender_healthy_cohort.csv")
...
alc_cohort.to_csv(updated_cohort_path + "alcohol_rare_cohort.csv")
...
alc_cohort.to_csv(updated_cohort_path + "alcohol_occasional_cohort.csv")
...
alc_cohort.to_csv(updated_cohort_path + "alcohol_regular_cohort.csv")
...
alc_cohort.to_csv(updated_cohort_path + "alcohol_daily_cohort.csv")
...
metadata_df_healthy = metadata_df_healthy[metadata_df_healthy["diabetes"] == 0]
metadata_df_healthy = metadata_df_healthy[metadata_df_healthy["antibiotic_history"].isin(["Year", "I have not taken antibiotics in the past year."])]
metadata_df_healthy = metadata_df_healthy[metadata_df_healthy["sex"] == 0]
...
pill_cohort.to_csv(updated_cohort_path + "pill_cohort.csv")
...
iud_cohort.to_csv(updated_cohort_path + "iud_cohort.csv")
...
asd_cohort.to_csv(updated_cohort_path + "asd_cohort.csv")
...
no_gluten_cohort.to_csv(updated_cohort_path + "no_gluten_cohort.csv")
...
celiac_cohort.to_csv(updated_cohort_path + "celiac_cohort.csv")
...
gluten_alergy_cohort.to_csv(updated_cohort_path + "gluten_alergy_cohort.csv")
...
usa_immigrant_cohort.to_csv(updated_cohort_path + "usa_immigrant_cohort.csv")
...
uk_immigrant_cohort.to_csv(updated_cohort_path + "uk_immigrant_cohort.csv")

###DIET TYPE GROUPS
print ("Constructing diet:  cohort with matched healthy samples")
omnivore_noRed_cohort = buildDataSubset(metadata_df_healthy, "diet_type", 1, 0, False) #"Omnivore but do not eat red meat"
...
omnivore_noRed_cohort.to_csv(updated_cohort_path + "omnivore_noRed_cohort.csv")

print ("Constructing diet: Pescatarian cohort with matched healthy samples")
pescatarian_cohort = buildDataSubset(metadata_df_healthy, "diet_type", 2, 0, False) #"Vegetarian but eat seafood"
...
pescatarian_cohort.loc[pescatarian_cohort["target"] == 2, "target"] = 1
pescatarian_cohort.to_csv(updated_cohort_path + "pescatarian_cohort.csv")

print ("Constructing diet: Vegetarian cohort with matched healthy samples") #Vegetarian
vegetarian_cohort = buildDataSubset(metadata_df_healthy, "diet_type", 3, 0, False)
...
vegetarian_cohort.loc[vegetarian_cohort["target"] == 3, "target"] = 1
vegetarian_cohort.to_csv(updated_cohort_path + "vegetarian_cohort.csv")

print ("Constructing diet: Vegan cohort with matched healthy samples")
vegan_cohort = buildDataSubset(metadata_df_healthy, "diet_type", 4, 0, False)
vegan_cohort = metadata_matching.loc[vegan_cohort, :]
vegan_cohort["target"] = metadata_df_healthy.loc[vegan_cohort.index, "diet_type"]
vegan_cohort.loc[vegan_cohort["target"] == 4, "target"] = 1
vegan_cohort.to_csv(updated_cohort_path + "vegan_cohort.csv")
...
bmf_less1_cohort.to_csv(updated_cohort_path + "bmf_less1_cohort.csv")
...
bmf_2_cohort.to_csv(updated_cohort_path + "bmf_2_cohort.csv")
...
bmf_3_cohort.to_csv(updated_cohort_path + "bmf_3_cohort.csv")
...
bmf_4_cohort.to_csv(updated_cohort_path + "bmf_4_cohort.csv")
...
bmf_5_cohort.to_csv(updated_cohort_path + "bmf_5_cohort.csv")
...
bmq_solid_cohort.to_csv(updated_cohort_path + "bmq_solid_cohort.csv")
...
bmq_loose_cohort.to_csv(updated_cohort_path + "bmq_loose_cohort.csv")
...
weigth_increase_cohort.to_csv(updated_cohort_path + "weigth_increase_cohort.csv")
...
weigth_decrease_cohort.to_csv(updated_cohort_path + "weigth_decrease_cohort.csv")
...
cauc_cohort.to_csv(updated_cohort_path + "caucasian_cohort.csv")
...
asian_cohort.to_csv(updated_cohort_path + "asian_cohort.csv")
...
africanA_cohort.to_csv(updated_cohort_path + "african_american_cohort.csv")
...
hispanic_cohort.to_csv(updated_cohort_path + "hispanic_cohort.csv")
